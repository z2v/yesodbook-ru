...
-- Укажите также, где найти библиотеки jQuery. Мы будем использовать значение
...
--
-- * Как обычно, у нас есть типы подсайта и главного сайта
--
...
-- завершилась, он отображает данные переданного человека. В ином случае -- снова

...
Пакет \footnotehref{http://hackage.haskell.org/package/monad-control}{monad-control} используется в нескольких местах внутри Yesod, в первую очередь для обеспечения надлежащей обработки исключений в Persistent. Это универсальный пакет, расширяющий стандартную функциональность трансформаторов монад.
...
Есть несколько подходов к решению этих проблем. В прошлом я реализовал решение используя семейство типов в пакете \footnotehref{http://hackage.haskell.org/package/neither}{neither}. Anders Kaseorg реализовал намного более простое решение в пакете \footnotehref{http://hackage.haskell.org/package/monad-peel}{monad-peel}. А для эффективности, в \footnotehref{http://hackage.haskell.org/package/monad-control}{monad-control}, Bas van Dijk использует стиль передачи продолжения (Continuation Passing Style, сокращённо CPS) и екзистенциальные типы.

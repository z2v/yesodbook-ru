...
Монада~\lstinline'base'~--- это основная монада, а~\lstinline'm'~--- это стек, построенный на ней. \lstinline'RunInBase'~--- это
функция, которая принимает значение всего стека, вытягивает~\lstinline'base' и размещает её
снаружи. В отличие от типа~\lstinline'Run', мы не замещали её произвольной монадой, а
...
Проще говоря, \lstinline'liftControlIO' принимает функцию, которая ожидает на вход функцию~\lstinline'RunInBase'. Эта

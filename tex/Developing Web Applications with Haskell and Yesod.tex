...
\fancyhead{}
\fancyfoot{}
\fancyhead[LO]{\rmfamily\small\raggedright\nouppercase\rightmark}
\fancyhead[RE]{\rmfamily\small\raggedleft\nouppercase\leftmark}
\fancyhead[RO,LE]{\rmfamily\small\thepage}
\pagestyle{fancy}
...
\newcommand{\includecode}[2][]{\lstinputlisting[title=#2, #1]{../hs/#2}}
\newcommand{\sourcecode}[3][]{\lstinputlisting[title=#3]{#2/#3}}
\long\def\ignore#1{}

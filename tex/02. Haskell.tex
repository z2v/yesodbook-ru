...
Если вам необходимо более полное введение в Haskell, я бы порекомендовал <<Real World Haskell>> или <<Learn You a Haskell>>.\marginpar{Возможно, стоит вставить ссылки на книги (в оригинале ссылок нет).}
...
% Как-то два раза подряд "в приведённых выше примерах". Может, перефразировать?
...
% Запятая с тире... Обычно такое в диалогах только встречается, нужно экспертное мнение
...
% если ВАШ код .. НАШИХ файлов.. то МЫ можем...
%Кажется, тут несоответствие. Могу ошибаться.
...
% возможно, имеет смысл перевести строку внутри примера.
\begin{lstlisting}

...
\foothref{http://hackage.haskell.org/package/conduit}{conduit} версии \verb=0.2=.
...
(\foothref{http://hackage.haskell.org/package/monad-control}{monad-control}):
...
модуля 
\foothref{http://hackage.haskell.org/packages/archive/conduit/latest/doc/html/Data.Conduit.List.html}{Data.Conduit.List}. Там есть аналоги для типичных функций работы со
списками, например, свертки. (Там так же есть некоторые кондуиты,
например, 
\foothref{http://hackage.haskell.org/packages/archive/conduit/latest/doc/html/Data-Conduit-List.html#v:map}{conduit:Data.Conduit.List:map}.)
...
\foothref{http://hackage.haskell.org/package/enumerator}{енумераторов}, вы увидете, что 

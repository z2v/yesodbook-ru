...
источника.
 \item \emph{Синки (sinks)} потребляет данные. Основные примеры будут о функции
суммирования
...
например, \lstinline'conduit:Data.Conduit.List:map'.)
...
драмы: \lstinline'Conduits' (тип, не пакет). % FIXME добавить ссылку

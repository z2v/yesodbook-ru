...
\footnotetext{\href{https://www.fpcomplete.com/user/snoyberg/library-documentation/conduit-overview}%
    {\texttt{https://www.fpcomplete.com/user/snoyberg/library-documentation/conduit-overview}}}.
...
% threading в данном случае имхо не относится к потокам, а говорит о ``протягивании'' эффектов (c) qrilka
...
Сток поглащает поток данных и производит результат. Он должен всегда выдавать результат
...
Подобное соединение заботится о проверке конструктора стока (\lstinline'SinkData' против

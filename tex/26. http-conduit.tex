...
% думаю, что это достаточно устоявшийся термин,
...
record-нотацию\footnote!Запись вида req { method = "HEAD" }!. Например, модификация
...
У типа данных~\lstinline!Response! есть переменная типа, чтобы 
...
\begin{remark}
Пакет conduit предоставляет ленивую реализацию модуля, которая

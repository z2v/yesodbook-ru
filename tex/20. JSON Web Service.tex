...
Давайте создадим простой веб-сервис: он будет принимать запрос в формате JSON и отдавать ответ в формате JSON. Мы напишем сервер на WAI/Warp, а клиент --- с помощью {http-conduit}. Мы будем использовать \footnotehref{http://hackage.haskell.org/package/aeson}{aeson} для разбора JSON и его отображения. Мы также могли бы написать сервер и на Yesod, но для такого простого примера большие возможности Yesod немногое нам дают.
